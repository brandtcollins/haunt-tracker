  ...
  return (
    <>
      ...
      <select
        id="location"
        name="location"
        className="mt-1 block w-full rounded-md bg-darkGray-100 text-white border-darkGray-100 py-2 pl-3 pr-10 text-base focus:border-indigo-500 focus:outline-none focus:ring-indigo-500 sm:text-sm"
        defaultValue="Canada"
      >
      ...
      <label
        htmlFor="steps-range"
        className="block mb-2 text-sm font-medium text-white py-4"
      >
      ...
      <div className="py-4">
        <div className="relative rounded-md border border-darkGray-100 px-3 py-2 my-2 shadow-sm focus-within:border-indigo-600 focus-within:ring-1 focus-within:ring-indigo-600">
          <label
            htmlFor="name"
            className="absolute -top-2 left-2 -mt-px inline-block bg-darkGray-300 px-1 text-xs font-medium text-white"
          >
          ...
          <input
            ...
            className="block w-full border-0 p-0 text-white placeholder-gray-500 focus:ring-0 sm:text-sm bg-darkGray-300"
