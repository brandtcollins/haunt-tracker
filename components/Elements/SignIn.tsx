            ...
            <div className="mt-6">
              <div className="relative">
                ...
                <div className="relative flex justify-center text-sm">
                  <span className="bg-darkGray-300 px-2 text-gray-500">
                    Or continue with
                  </span>
                </div>
              </div>
              ...
              <div className="mt-6 grid grid-cols-3 gap-3">
                <div>
                  <a
                    href="#"
                    className="inline-flex w-full justify-center rounded-md border border-emerald-300 bg-emerald-500 py-2 px-4 text-sm font-medium text-gray-500 shadow-sm hover:bg-emerald-700"
                  >
